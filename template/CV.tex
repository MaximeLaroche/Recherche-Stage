...
\begin{document}
	...
	\begin{rSection}{Projets}
		\begin{rSubsection}{Serveur TCP de Fichier}{2021}{}{}
			...
			\item Permets de faire des sauvegardes automatiques des appareils sur le réseau local, ainsi que de partager des fichiers entre les machines du réseau.
		\end{rSubsection}
	...
	\begin{rSection}{Expérience}
		...
		\begin{rSubsection}{Ingénierie de service}{2020}{Bombardier}{}{}
			\item Référence: Alexandre Turgeon

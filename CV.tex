...
\begin{document}
	...
	\begin{rSection}{Expérience}
		...
		\begin{rSubsection}{Ingénierie de service}{2020}{Bombardier}{}{}
			\item Conception de logiciel de collection et analyse de données pour optimiser l'organisation du travail au sein de la compagnie. \\ \color{white}\hspace{1cm} \color{black} 
			Projet fait en conception itérative. \\ \color{white}\hspace{1cm} \color{black} 
			Apprentissage d'un langage sur le tas.

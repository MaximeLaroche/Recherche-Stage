...
\address{(514) 348 - 0345 \\ Maxime-1.Laroche@polymtl.ca \\ \href{https://maximelaroche.github.io/portfolio}{maximelaroche.github.io/portfolio}}
...
\begin{document}
	...
	\begin{rSection}{Expérience}
		...
		\begin{rSubsection}{Ingénieur Full Stack}{2022}{Morgan Stanley}{}{}
			\item Conception et implémentation d'un site web avec react et du back end avec spring boot
			\item Déploiment de base de données avec un outil basé sur liquibase
			\item Rédaction de tests
		\end{rSubsection}

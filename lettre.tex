...
\begin{letter}{Technologies Expretio Inc}
...
En 2021, mes collègues et moi avons travaillé sur un projet: c’était fort intéressant et d’ailleurs, j’ai accordé la majorité de mon temps dessus.  Cela m'a permis d’acquérir de l’expérience en développement full stack.  Ceci consistait à implémenter un jeu de Scrabble en ligne! Angular sur Typescript était le framework utilisé pour l'application client de ce projet. Évidemment, beaucoup de tests en Typescript ont été faits pour assurer la qualité de notre logiciel. Après tout, le monde digital est vraiment le futur, que ce soit construire des sites Internet, des publicités, des jeux, etcétéra! S'assurer que les logiciels soient déployés avec un certain standard de qualité est très important et m'intéresse beaucoup.  Cela va de soi que j’aimerais bien vous offrir mes services de développeur.  
